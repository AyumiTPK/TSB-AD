...
if __name__ == '__main__':
    ...
    parser.add_argument('--AD_Name', type=str, default='TTM_ZS')
    ...
    print("Semisupervise_AD_Pool =", Semisupervise_AD_Pool)
    print("Unsupervise_AD_Pool =", Unsupervise_AD_Pool)
    print("AD_Name =", args.AD_Name)
